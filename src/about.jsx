  ...
  return (
    ...
    >
      <div className="flex">
        {/* Judul */}
        <h2
          className="text-[16px] ml-[45px] max-w-[100000px] font-bold mb-[2px] mr-[200px]"
          style={{
        ...
        <div className="flex">
          ...
          >
            {images.map((image, index) => {
              // Menentukan ukuran gambar berdasarkan urutan ganjil/genap
              const sizeClass =
                index % 2 === 0
                  ? "w-[150px] h-[150px]" // Gambar genap
                  : "w-[220px] h-[150px]"; // Gambar ganjil
